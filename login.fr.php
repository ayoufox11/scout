...
<body>
    <div class="login-container">
        <div class="login-title" style="clear:both;">Connexion à l'espace membres</div>
        ...
        <div class="login-footer">
            Vous n'avez pas de compte ? <a href="register.fr.php" style="color:#624c78; text-decoration:underline;">Inscrivez-vous</a>
        </div>
