...
<body>
    <div class="register-container">
        <div class="register-title">إنشاء حساب عضو جديد</div>
        <form class="register-form" method="post" action="#">
            ...
            <input type="password" id="confirm" name="confirm" placeholder="تأكيد كلمة المرور" required>
            <button type="submit">إنشاء حساب</button>
        </form>
        <div class="register-footer">
            لديك حساب بالفعل؟ <a href="login.php" style="color:#624c78; text-decoration:underline;">سجّل الدخول</a>
        </div>
